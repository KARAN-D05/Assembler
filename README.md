...
│   ├── 📁 asm-v0.1
│   │   ├── 📁 images
│   │   │   ├── 📄 machine-code output.png
│   │   │   ├── 📄 program-execution-r_a_mv3.png
│   │   │   └── 📄 program-execution-r_a_mv4.png
│   │   ├── 🐍 assembler.py
│   │   └── 📝 Readme.md
│   ├── 📁 asm-v0.2
│   │   ├── 📁 images
...
│   ├── 📁 asm-v0.3
│   │   ├── 📁 images
│   │   │   ├── 📄 asmv0.3_no_input.png
│   │   │   ├── 📄 asmv0.3_output.png
│   │   │   ├── 📄 semantic_analysis.png
│   │   │   ├── 📄 syntax_analysis1.png
│   │   │   ├── 📄 syntax_analysis2.png
│   │   │   └── 📄 syntax_analysis3.png
│   │   ├── 🐍 assembler.py
│   │   └── 📝 Readme.md
│   ├── 📁 Sample-Programs
│   │   ├── 📄 P1.asm
...
(.md: 8  .py: 3  .c: 2  .bat: 3  .sh: 3  .ps1: 2)
```

> *Generated by [filetree](https://github.com/KARAN-D05/portmap-HDL/tree/main/utils) - Repo Filetree generator*
