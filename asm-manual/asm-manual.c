...
// ------------------------------------------------------------
//  Project  : Assembler for Custom Hardware
//  File     : asm-manual.c
...
void manual_v01() {
    ...
    printf("\n MNEMONICS (v0.1 only has these two)\n");
    printf(" ------------------------------------\n");
    ...
    printf("     v0.1 only: STORE is abstracted away in v0.2+\n");
...
void manual_v02() {
    ...
    printf("     S=0 -> Register A | S=1 -> Register B\n");
    ...
    printf("\n [4] SUB\n");
    printf("     Function : Subtracts Register B from Register A.\n");
    printf("     Note     : Use HOLD-OP after to retain result.\n");

    printf("\n [5] DIV\n");
    printf("     Function : Divides Register A by Register B.\n");
    printf("     Note     : Use HOLD-OP for (quotient) cycles.\n");

    printf("\n [6] MUL-XXXX\n");
    printf("     Function : Multiplies Register B by (XXXX - 1).\n");
    printf("     Example  : 0010 -> value=4, multiplier=3\n");
    printf("     Note     : Use HOLD-OP for (multiplier+1) cycles.\n");

    printf("\n [7] OVRD\n");
    printf("     Function : Overrides overflow halt.\n");

    printf("\n [8] RSTM\n");
    printf("     Function : Resets entire machine to 0.\n");

    printf("\n [9] HOLD-OP\n");
    printf("     Function : Holds output for N clock cycles.\n");
    printf("     Rule     : MUL -> hold (multiplier+1) cycles\n");
...
void manual_v03() {
    ...
    printf(" See v0.2 for the full mnemonic list.\n");
    printf(" v0.3 adds a validation layer on top of them.\n");

    printf("\n KEY FEATURES\n");
    printf(" ------------\n");

    printf("\n [1] SYNTAX ANALYSIS\n");
    printf("     - Validates each instruction before translation.\n");
    printf("     - Detects invalid LOAD structure.\n");
    printf("     - Detects non-binary selector or data bits.\n");
    printf("     - Detects incorrect instruction length.\n");

    printf("\n [2] PRIMITIVE SEMANTIC ANALYSIS\n");
    printf("     - Prevents arithmetic before any LOAD.\n");
    printf("     - Detects invalid machine states.\n");
    printf("     - Halts with descriptive error messages.\n");
...
void manual_all() {
    ...
    printf("+------------------------------------------------------+\n");
    printf("\n  v0.1 -> LOAD-S-XXXX + STORE only\n");
    printf("  v0.2 -> STORE abstracted, full mnemonic set added\n");
    printf("  v0.3 -> Syntax & Primitive Semantic Analysis layer\n");
...
int main(int argc, char *argv[]) {
    ...
    // ./asm-manual --search (no query given)
    if (argc == 2 && strcmp(argv[1], "--search") == 0) {
        printf("Usage: ./asm-manual --search <mnemonic>\n");
        printf("Example: ./asm-manual --search LOAD\n");
        return 1;
    }
    ...
    printf("+------------------------------------------------------+\n");
    printf(" Tip: search a mnemonic directly from terminal:\n");
    printf("      ./asm-manual --search LOAD\n");

    while (1) {
        printf("\n Available: v0.1 | v0.2 | v0.3 | all | search | exit\n");
        ...
        if (strcmp(input, "v0.1") == 0) {
            ...
            printf(" Try: v0.1, v0.2, v0.3, all, search, exit\n");
        }
    }
...
void manual_v01() {
    ...
    printf("                Example: 0011 -> 8+4 = 12\n");
    printf("\n" BOLD_WHITE "       Bit Indexing Convention:\n" RESET);
    printf("         Bit 0 = MSB (weight 8)\n");
    printf("         Bit 3 = LSB (weight 1)\n");
    printf("\n" BOLD_WHITE "       Data Field Layout:\n" RESET);
    printf("         Index  -> [3] [2] [1] [0]\n");
    printf("         Weight ->  1   2   4   8\n");
    ...
    print_note("Reads selector from LOAD, inserts into machine code.");
